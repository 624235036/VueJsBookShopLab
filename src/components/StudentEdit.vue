...
export default {
    ...
    methods: {
        async SaveStudent() {
            ...
            if (confirm("Do you want to save?")) {
                ...
                await axios.put(this.$apiUrl + "student/" + this.$route.params.number , this.student,{ headers: { Authorization: `bearer ${this.accessToken}` } });
    ...
    if (await this.accessToken) {
      try {
            ...
            const response = await axios.get(this.$apiUrl + "student/" + this.$route.params.number,{ headers: {"Authorization" : `bearer ${this.accessToken}`} });
